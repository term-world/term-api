...
for poll in active_polls:
    ...
    choice_index += 1
user_choice = int(input("Enter the number of the poll you'd like to close: "))
...
if confirmation == "y":
    ...
    print("Above results have been submitted to poll database.")
...
#SEPARATE TO-DO: CREATE A "RESULTS" VIEW COUCHDB